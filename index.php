...
<div id="middle">
	<div id="middle_inside">
          	<div id="middle_news">今日新闻</div>
                <div id="middle_news_content">
          	</div>
                <div id="middle_news_more"><a href="news.php">更多新闻&gt;&gt;</a></div>
          	
                <!-- 主体右侧内容 -->
                
                <div id="middle_right_box"></div>
                <div id="middle_right_content">
                	<div class="middle_right_content_styles">
                	大学生职业发展协会成立于2006年，致力于为北理工的同学们创造一个与职场息息相关的平台，提高就业竞争力，现已发展为6大部门以及4个专业组：
